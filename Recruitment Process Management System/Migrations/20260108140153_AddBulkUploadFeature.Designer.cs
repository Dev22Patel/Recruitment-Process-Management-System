...
namespace Recruitment_Process_Management_System.Migrations
{
    ...
    [Migration("20260108140153_AddBulkUploadFeature")]
    partial class AddBulkUploadFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ApplicationReviewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.BulkUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.JobPositionReviewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("JobPositionReviewers");
                });
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ReviewerSkillVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ScreeningReviewId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ScreeningReviewId");

                    b.HasIndex("VerifiedBy");

                    b.ToTable("ReviewerSkillVerifications");
                });
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ScreeningReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsRecommendedForInterview")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EntityType = "Screening",
                            IsActive = true,
                            StatusName = "Needs Clarification"
                        },
                        new
                        {
                            Id = 19,
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ApplicationReviewer", b =>
                {
                    ...
                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.BulkUpload", b =>
                {
                    ...
                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.User", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.JobPositionReviewer", b =>
                {
                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.User", "Assigner")
                        .WithMany()
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ReviewerSkillVerification", b =>
                {
                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.CandidateSkill", "CandidateSkill")
                        .WithMany()
                        .HasForeignKey("CandidateSkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.ScreeningReview", "ScreeningReview")
                        .WithMany("SkillVerifications")
                        .HasForeignKey("ScreeningReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recruitment_Process_Management_System.Models.Entities.User", "Verifier")
                        .WithMany()
            ...
            modelBuilder.Entity("Recruitment_Process_Management_System.Models.Entities.ScreeningReview", b =>
                {
                    b.Navigation("SkillVerifications");
                });
